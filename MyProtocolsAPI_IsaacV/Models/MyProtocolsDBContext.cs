...
namespace MyProtocolsAPI_IsaacV.Models
{
...
//                optionsBuilder.UseSqlServer("SERVER=.\\SQLEXPRESS;DATABASE=MyProtocolsDB; INTEGRATED SECURITY=FALSE; USER ID=MyProtocolsAPIUser; PASSWORD=123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Protocol>(entity =>
            {
                ...
                entity.HasMany(d => d.ProtocolStepProtocolSteps)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("ProtocolProtocolId", "ProtocolStepProtocolStepsId").HasName("PK__Protocol__7C2612956279EBC7");
            ...
            modelBuilder.Entity<ProtocolCategory>(entity =>
            {
                entity.HasKey(e => e.ProtocolCategory1)
                    .HasName("PK__Protocol__0ED5AEE58A3EF7E5");
            ...
            modelBuilder.Entity<ProtocolStep>(entity =>
            {
                entity.HasKey(e => e.ProtocolStepsId)
                    .HasName("PK__Protocol__C75F186EF09EDD97");
